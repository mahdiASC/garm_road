...
Item.create(:user_id=>1, :name=>"Nike shoes", :condition => "new", :item_type => "shoes", :img => "https://media.kohlsimg.com/is/image/kohls/2940131_Gray_Black", :current_possessor_user_id => 3)
Item.create(:user_id=>2, :name=>"Blue shirt", :condition => "lightly used", :item_type => "shirt", :img => "https://wordans-mxelda46illwc0hq.netdna-ssl.com/wordansfiles/model_specifications/2015/8/28/117441/117441_big.jpg?1440803233", :current_possessor_user_id => 2)
Item.create(:user_id=>3, :name=>"Red Hat", :condition => "worn", :item_type => "accessory", :img => "http://assets.craniumfitteds.com/images/main/Washington-Nationals-Red-Black-Gray-New-Era-Cap-Fitted-Hat-59fifty-1.jpg", :current_possessor_user_id => 2)
